...
import { ClearMessageEvent } from '../../message/event';
...
describe('c-member-skills', () => {
    ...
    it('should clear the success message after the given time', async () => {
        // GIVEN
        const memberInformation = {
            Name: 'Test Member Name',
            Skills__c: 'Test skills',
        ...
        const messageComponent = element.shadowRoot.querySelector('c-message');
        messageComponent.dispatchEvent(new ClearMessageEvent());
        await wait();
        expect(element).toMatchSnapshot();
    });
});
